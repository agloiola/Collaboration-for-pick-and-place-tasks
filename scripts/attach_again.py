...
def attach_received_callback(msg):
    global attach 
    attach  = msg.data
    rospy.loginfo("Recebido sinal do objeto: " + str(attach ))


if __name__ == '__main__':
    
    rospy.Subscriber('/attach', Bool, attach_received_callback)
